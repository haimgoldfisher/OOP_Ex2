...
public class GUI extends JFrame implements ActionListener {
    ...
    JFrame popup;
    JFrame connectedpop;
    MyDirectedWeightedGraphAlgorithms g1;
    MyDirectedWeightedGraphAlgorithms og;
    int source;
    int destination;
    NodeData center;
    NodeData startpoint;
    ...
    public GUI(MyDirectedWeightedGraph gr) {
    ...
    public class GraphP extends JPanel {
        ...
        public GraphP(MyDirectedWeightedGraph gr) {
            g1 = new MyDirectedWeightedGraphAlgorithms();
            og = new MyDirectedWeightedGraphAlgorithms();
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == centerb) {
            ...
            if (response == JFileChooser.APPROVE_OPTION) {
                ...
                try {
                    runGUI((MyDirectedWeightedGraph) this.g1.getGraph());
    ...
    public static void runGUI(MyDirectedWeightedGraph gr) {
        new GUI(gr);
    }

    public static void main(String[] args){
        if(args.length!=0){
            MyDirectedWeightedGraphAlgorithms alg = new MyDirectedWeightedGraphAlgorithms();
            alg.load(args[0]);
            runGUI((MyDirectedWeightedGraph)alg.getGraph());
        }else{
            runGUI(null);
        }
    }
